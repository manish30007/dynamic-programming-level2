...
//   }
// };
// bool checkcomponentbipartite( vector<vector<Edge>> graph, int src, vector<int>& visited) {
//   queue<Pair>q;
...
//     if (visited[i] == -1) {
//       bool iscompobipartite = checkcomponentbipartite(graph, i, visited);
//       if (iscompobipartite == false) {
//         cout << "false";
//         return 0;
//       }
//     }
